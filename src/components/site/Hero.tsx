  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="container-x grid gap-10 py-10 md:py-16 lg:grid-cols-[1.1fr_1fr] items-center">
        <div>
          <div className="group inline-flex items-center gap-2.5 rounded-full border border-primary/30 bg-gradient-to-r from-primary/[0.10] via-primary/[0.06] to-primary/[0.10] px-4 py-2 text-sm font-bold text-primary-deep shadow-[0_0_0_1px_rgba(var(--color-primary),0.1)_inset,0_6px_20px_-10px_rgba(var(--color-primary),0.35)] backdrop-blur-sm animate-badge-glow">
            ...
            <span className="relative">
              <span className="absolute -inset-1 rounded-full bg-primary/10 blur-md opacity-0 group-hover:opacity-100 transition-opacity" />
              <span className="relative">{hero.eyebrow}</span>
            </span>
            <ShieldCheck className="h-4 w-4 shrink-0 text-primary/80" />
          </div>
